...
// var sever_connect = 'receiver.hino-connect.vn';
// var port_connect = 30129;

var sever_connect = 'hinogps.onelink-iot.com'; // hino thailand 10001, 'hinogps.onelink-iot.com
var port_connect = 10001;
...
function t500Set_voice_hino_A(hexstr, datastr) {
  // console.log("imeiread", hexstr)
  var functionid = "8700";
...
router.get('/', function (req, res, next) {
  res.render('Sendcommand/hino_send_command');
});
...
router.post("/Set_voice_hino_A", function (req, res, next) {
  dataX2="";
  var {  
      fileContents,
      setimei,
  ...
  var datacommand = t500Set_voice_hino_A(setimei, Set_voice_hino_A1);
  openconnection(setimei, datacommand);
