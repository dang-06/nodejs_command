...
router.post("/readconfig", function (req, res, next) {
  ...
  // CloseConnection();
  res.render('asap_send_command_1', { title: 'User List', userData: dataX1, valueimei: controldata1 });
...
router.post("/Send_SMS", function (req, res, next) {
  ...
  axios(config)
    .then(function (response) {
      ...
      res.render('SMS_true_22_1', { title: 'User List', userData: dataX1, valueimei: controldata1, value_phone: controldata_phone, value_msg: controldata_msg });
    })
