...
router.post("/Send_SMS", function (req, res, next) {
  ...
  axios(config)
    .then(function (response) {
      ...
      res.render('SMS_AIS_24_1', { title: 'User List', userData: dataX1, valueimei: controldata1, value_phone: controldata_phone, value_msg: controldata_msg });
    })
