...
router.post("/Send_SMS", function (req, res, next) {
  ...
  var config = {
    method: 'post',
    url: 'http://210.1.9.13:80/sendsms?username=admin&password=onelink&phonenumber=' + setphone + '&message=' + setmsg + '&port=gsm-2.3',
    headers: {
  ...
  axios(config)
    .then(function (response) {
      ...
      res.render('SMS/SMS_AIS_23_1', { title: 'User List', userData: dataX1, valueimei: controldata1, value_phone: controldata_phone, value_msg: controldata_msg });
    })
