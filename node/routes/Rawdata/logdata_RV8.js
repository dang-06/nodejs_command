...
var dataX1 = "";
var dataQ = "select * from log_12500_rv8 order by id desc limit 50;";
var fileQ = "log_12500_rv8";
...
router.get('/', function (req, res, next) {
  ...
  res.render('Rawdata/logdata_RV8', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('Rawdata/logdata_RV8_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
