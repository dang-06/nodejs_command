...
var dataX1 = "";
var dataQ = "select * from log_12300_dt800 order by id desc limit 50;";
var fileQ = "log_12300_dt800";
...
router.get('/', function (req, res, next) {
  ...
  res.render('Rawdata/logdata_DT800', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('Rawdata/logdata_DT800_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
