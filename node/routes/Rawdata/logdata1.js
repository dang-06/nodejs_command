...
var dataX1 = "";
var dataQ = "select * from log_11200 order by servertime desc limit 50;";
var fileQ = "log_11200";
...
router.get('/', function (req, res, next) {
  ...
  res.render('Rawdata/logdata1', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('Rawdata/logdata1_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
