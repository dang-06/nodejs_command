...
var dataX1 = "";
var dataQ = "select * from jc400_log_11800 order by id desc limit 50;";
var fileQ = "jc400_log_11900";
...
router.get('/', function (req, res, next) {
  ...
  res.render('Rawdata/logdata_JC400', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('Rawdata/logdata_JC400_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
