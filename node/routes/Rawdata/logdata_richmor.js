...
var dataX1 = "";
var dataQ = "select * from log_13100_richmor order by id desc limit 50;";
var fileQ = "log_13100_richmor";
...
router.get('/', function (req, res, next) {
  ...
  res.render('Rawdata/logdata_richmor', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('Rawdata/logdata_richmor_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
