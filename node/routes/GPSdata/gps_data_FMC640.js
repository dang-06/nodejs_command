...
var setimei = "";
var setlimit = "";
var setdate = "order by server_unit_time desc";

var dataX1 = "";

var dataQ = "select * from log_decode_11200 order by server_unit_time desc limit 50;";

var fileQ = "log_decode_11200";

var culumname = "server_stam_date"
...
router.get('/', function (req, res, next) {
  ...
  res.render('GPSdata/gps_data_FMC640', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('GPSdata/gps_data_FMC640_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
