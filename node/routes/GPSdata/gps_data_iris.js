...
var dataQ = "select * from log_decode_13300_IRIS order by id desc limit 50;";

var fileQ = "log_decode_13300_iris";
...
router.get('/', function (req, res, next) {
  ...
  res.render('GPSdata/gps_data_IRIS', { title: 'Express', timenow: datatime1 });
...
router.post("/add", function (req, res, next) {
  ...
  pool.connect((err, Client, release, result) => {
    ...
    res.render('GPSdata/gps_data_IRIS_1', { title: 'User List', userData: dataX1, valueimei: controldata1, valuedate: controldatadate, valuelimit: controldatalimit, valuelimit2: controldatalimit2 });
